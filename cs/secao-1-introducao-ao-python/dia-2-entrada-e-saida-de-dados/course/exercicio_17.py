'''
Leia seu conteúdo e calcule a porcentagem de livros em cada categoria em
relação ao número total de livros. O resultado deve ser escrito em um arquivo
no formato CSV.
'''
import json
import csv
...
if __name__ == "__main__":
    # retrieve books
    with open("exercicio_17.json") as file:
        books = recupera_books(file)
    ...
    with open("exercicio_17.csv", "w") as file:
