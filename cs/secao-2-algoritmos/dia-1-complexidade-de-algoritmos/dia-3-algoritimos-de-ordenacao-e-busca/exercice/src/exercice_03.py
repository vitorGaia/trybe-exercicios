...
# Desempenho muito melhor no pior caso e semelhante ao insertion no caso médio
...
for algorithm in (insertion_sort, selection_sort):
    algorithm_name = algorithm.__name__  # .__name__ é nativo do python

    for input in (5_000, 50_000):
